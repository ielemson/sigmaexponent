...
<div class="row">
    <div class="col-md-12">
        <div class="card ">
            <div class="card-body">
                <form action="{{ route("blog.update",$post->id) }}" method="POST" enctype="multipart/form-data" role="form"
                    id="uploadForm">
                    @csrf
                    @method("PUT")
                        ...
                        <div class="box box-primary">
                            <div class="box-body">
                                <div class="row">
                                    <div class="col-md-4">
                                        <div class="form-group">
                                            ...
                                            <input type="text" name="title" placeholder="News title"
                                                class="form-control" id="newstitle" required value="{{ $post->title }}">
                                        </div>
                                    </div>
                                    ...
                                    <div class="col-md-4">
                                        <div class="form-group">
                                            <label for="status">Categories</label> <span class="text-danger">*</span>
                                            <select class="form-control" name="cat_id" id="status" required="">
                                                <option value="" selected="selected">-- Select an option --
                                                </option>
                                                @foreach ($categories as $category)
                                                     <option value="{{ $category->id }}" {{ $category->id === $post->cat_id ? 'selected' : '' }}>{{ $category->cat_name }}</option>  
                                                @endforeach
                                    ...
                                    <div class="col-md-12">
                                        <div class="form-group">
                                            ...
                                            <textarea class="textarea html-editor form-control" name="content" id="summernote" required>{{ $post->content }}</textarea>
                                        </div>
                                    </div>
                                    ...
                                    <div class="col-md-6">
                                        <div class="form-group">
                                            ...
                                            <input type="text" name="meta_title" placeholder="Meta  title"
                                                class="form-control" id="meta_title" value="{{ $post->meta_title }}">
                                        </div>
                                    </div>
                                    <div class="col-md-6">
                                        <div class="form-group">
                                            ...
                                            <input type="text" name="meta_keywords" placeholder="Meta Keywords"
                                                class="form-control" id="meta_keywords" value="{{ $post->meta_keywords }}">
                                        </div>
                                    </div>
                                    <div class="col-md-6">
                                        <div class="form-group">
                                            ...
                                            <input type="text" name="meta_description"
                                                ...
                                                id="meta_decription" value="{{ $post->meta_description }}">
                                        </div>
                                    </div>
                                    ...
                                    <div class="col-6">
                                        <div class="form-group">
                                            ...
                                            <input class="form-control" type="datetime-local" name="published_at"
                                                id="published_at" placeholder="Published At" required="" value="{{ $post->published_at }}">
                                        </div>
                                    </div>
                                </div>
                    ...
                    <div class="row">
                        ...
                        <div class="col-md-4">
                            <div class="box-footer">
                                ...
                                <a href="{{ route("blog.index") }}"  class="btn btn-warning btn-flat">Cancel</a>
                            </div>
                        </div>
                    </div>
                </form>
